...
import electriciteImage from "@/assets/electricité industrielle.png";
import eclairageImage from "@/assets/eclairage_industrielle.jpg";
import extractionImage from "@/assets/Extraction d'air.jpg";
...
const Services = () => {
  ...
  return (
    <section id="services" className="py-20 bg-industrial-bg">
